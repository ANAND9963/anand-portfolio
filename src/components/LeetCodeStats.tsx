    ...
    if (!user) {
        return (
            <section className="container mt-16">
                <h2 className="text-2xl md:text-3xl font-bold text-center text-white">LeetCode Stats</h2>
                <p className="text-center text-red-500 mt-4">Failed to load LeetCode stats.</p>
            </section>
        )
    }
    ...
    return (
        <section className="container mt-16">
            ...
            <div className="flex flex-col items-center mt-8 bg-gray-900 rounded-2xl p-6 shadow-xl">
                ...
                <p className="mt-4 text-lg font-semibold text-gray-200">Total Solved: {total}</p>
            </div>

            {/* Badges + Heatmap */}
            <div className="mt-8 bg-gray-900 rounded-2xl p-6 shadow-xl text-center">
                <h3 className="text-lg font-semibold text-white mb-4">Progress & Badges</h3>
                <img
